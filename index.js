// Допоміжні функції для перетворення між градусами та радіанами
...
function triangle(value1, type1, value2, type2) {
    ...
    if (type1 === "leg" && type2 === "leg") {
        ...
        if (a >= c) {
            console.log("Помилка: катет не може бути більшим або рівним за гіпотенузу.");
            return "failed";
        }
        b = Math.sqrt(c * c - a * a);
        alpha = radToDeg(Math.asin(a / c));
    ...
    console.log("a = ".concat(a.toFixed(10)));
    console.log("b = ".concat(b.toFixed(10)));
    console.log("alpha = ".concat(alpha.toFixed(10)));
    console.log("beta = ".concat(beta.toFixed(10)));
    console.log("c = ".concat(c.toFixed(10)));
    console.log("success");
    return "success";
}
